...
#this h1 is header/main tag
 ...
 vendor for all:  project.css

GOOD: first item title: project.css <h2 class="title___3Yk1c mb6 mt0 lh-none">Burt's Bees Holiday Family Pajamas</h2>

first item description: project.css <a href="https://www.today.com/parents/holiday-family-matching-pajama-set-ideas-t117017" target="_blank" class=" vilynx_listened">matching family pajamas</a>
# first item's description

first item BETTER description: project.css <h2 class="title___3Yk1c mb6 mt0 lh-none">Burt's Bees Holiday Family Pajamas</h2>
first item DETAILED DESCRIPTION: project.css <p class="">These adorable <a href="https://www.today.com/parents/holiday-family-matching-pajama-set-ideas-t117017" target="_blank" class=" vilynx_listened">matching family pajamas</a>, available in both blue and red, will make for some great photo ops this holiday season.</p>

first item price: project.css <span class="ListicleProduct__priceBtn cost___1u0dk cost___1P-qJ ls-normal lh-none df items-center justify-center bg-transparent fw5 founders-mono">$<!-- -->10</span>
# Possible html for product price of first item
...
second item description: project.css <strong>2. APL: Athletic Propulsion Labs Women's Techloom Bliss Sneakers, $200, <a href="https://www.amazon.com/gp/product/B07FF7NVSM?tag=118330-oprahfavoritethings-20" target="_blank">Amazon</a></strong>
<
#Better <h2 class="title___3Yk1c mb6 mt0 lh-none">APL: Athletic Propulsion Labs Women's Techloom Bliss Sneakers</h2>option for html for second item description:  project.css
second item BETTER DETAILED description: <p class="">Easily go from the gym to a nice lunch in these stylish sneakers, which come in seven different colors.</p>
...
third item description: project.css <h2 class="title___3Yk1c mb6 mt0 lh-none">Glamourpuss NYC Knitted Faux Fur Mitten</h2>
third item BETTER DETAILED description: project.css <p class="">Dress up any outfit with these playful, cozy faux fur mittens. Since one size fits most, these make great gifts for a range of people. Try pairing them with the <a href="https://www.amazon.com/gp/product/B07HJDQMV6?tag=118330-oprahfavoritethings-20" target="_blank">matching slippers</a>, also on Oprah's list.</p>
